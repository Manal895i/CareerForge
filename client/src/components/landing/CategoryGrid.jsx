...
const categories = [
  { emoji: '🧩', title: 'Data Structures & Algorithms', problems: '850+ Problems', tag: 'Most Popular', color: '#7C3AED' },
  ...
  { emoji: '☁️', title: 'Cloud Computing', problems: 'AWS, GCP, Azure', tag: 'Certification', color: '#7C3AED' },
];
      ...
      <div className="container">
        ...
        >
          ...
          <h2 style={{
            ...
            Explore Our <span style={{ background: 'linear-gradient(135deg, #0D9488, #06B6D4)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>Learning Tracks</span>
          </h2>
